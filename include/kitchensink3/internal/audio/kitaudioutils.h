 ...
 *
 * The 64-bit formats narrow to their 32-bit SDL equivalent (S64 to SDL_AUDIO_S32, DBL to
 * SDL_AUDIO_F32), since SDL has no 64-bit audio formats.
 *
 * @param fmt FFmpeg sample format
 * @return Closest matching SDL audio format (defaults to SDL_AUDIO_S16 for anything without a match)
 */
