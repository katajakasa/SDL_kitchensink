...
int main(void) {
    ...
    req_format_f32.format = AUDIO_F32SYS;
    ...
    const AudioRequestCase request_cases[] = {
        {"format_s16sys",          VIDEO_FILE,    req_format,     CHECK_FORMAT,      AUDIO_S16SYS, 0,     KIT_LAYOUT_UNKNOWN},
        {"format_s16sys_s32_flac", S32_FLAC_FILE, req_format,     CHECK_FORMAT,      AUDIO_S16SYS, 0,     KIT_LAYOUT_UNKNOWN},
        {"format_f32sys",          VIDEO_FILE,    req_format_f32, CHECK_FORMAT,      AUDIO_F32SYS, 0,     KIT_LAYOUT_UNKNOWN},
